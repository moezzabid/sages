...
import org.sid.sages.dao.ImageRepository;
...
public class ImageService {
	 private Path fileStorageLocation = null;
	    ...
	    private ImageRepository docStorageRepo;
	 
	 
	     @Autowired
	     private ImageService(Image image) {
	 
	         this.fileStorageLocation = Paths.get(image.getUploadDir())
	     ...
	     public String storeFile(MultipartFile file, Integer userId, String docType) {
	         ...
	         try {
	          ...
	          // Copy file to the target location (Replacing existing file with the same name)
	             ...
	             throw new ImageException("Could not store file " + fileName + ". Please try again!", ex);
